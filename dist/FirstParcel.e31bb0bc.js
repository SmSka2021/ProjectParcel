...
var getDay = function getDay() {
  var today = new Date();
  var daysArr = ["Воскресенье", "Понедельник", "Вторник", "Среда", "Пятница", "Суббота", "Воскресенье"];
  return daysArr[today.getDay()];
};

var day = document.querySelector('.myDay');
...
function myHelloStyle2() {
  ...
  styl.addEventListener("click", function () {
    document.getElementById("helloStyle").style.color = "red";
  });
}

function myHelloStyle() {
  var styll = document.getElementById("myHelloStyle");
  styll.addEventListener("click", function () {
    document.getElementById("helloStyle").style.color = "green";
  });
}
...
function myHidden() {
  ...
  bt.addEventListener("click", function () {
    document.getElementById("imgVisibility").style.visibility = "hidden";
  });
}
...
function myVisible() {
  ...
  btt2.addEventListener("click", function () {
    document.getElementById("imgVisibility").style.visibility = "visible";
  });
}
...
//# sourceMappingURL=/FirstParcel.e31bb0bc.js.map